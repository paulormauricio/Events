...
provider('ngGPlacesAPI', function () {
    ...
    var defaults = {
        ...
        map: null,
        elem: null,
        nearbySearchKeys: ['name', 'place_id', 'vicinity', 'photos', 'opening_hours', 'geometry', 'types'],
        placeDetailsKeys: ['formatted_address', 'formatted_phone_number', 'reference', 'website', 'photo_reference', 'types'],
